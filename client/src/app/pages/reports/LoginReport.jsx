...
const LoginReport = () => {
  ...
  const columns = [
    {
      name: 'Admin User',
      selector: (row) => (row.adminUser ? row.adminUser : '-'),
      sortable: true,
      // width: '200px',
    },
    {
      name: 'Admin Role',
      selector: (row) => (row.adminRole ? row.adminRole : '-'),
      sortable: true,
      // width: '200px',
    },
    {
      name: 'Admin Email',
      selector: (row) => (row.adminEmail ? row.adminEmail : '-'),
      sortable: true,
      // width: '200px',
    },
    {
      name: 'IP Address',
      selector: (row) => (row.ipAddress ? row.ipAddress : '-'),
      sortable: true,
      // width: '200px',
    },
    // {
    //   name: 'OS',
    //   selector: (row) => (row.os ? row.os : '-'),
    //   sortable: true,
    // width: '200px',
    // },
    // {
    //   name: 'Browser',
    //   selector: (row) => (row.browser ? row.browser : '-'),
    //   sortable: true,
    // width: '200px',
    // },
    // {
    ...
    {
      name: 'Login Date',
      selector: (row) => (row.loginDate ? row.loginDate : '-'),
      sortable: true,
      // width: '200px',
    },
    // {
